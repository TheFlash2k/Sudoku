...
int main() {
	...
	int maxEmptySpaces; // The number of empty spaces in a table.
	...
	cout << "---- NOTE: User input is being taken in through getche() function so there's no need to press enter. Just enter the value.\n\n";
